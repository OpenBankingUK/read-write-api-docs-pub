      ...
      "Product":[
         {
            ...
            "PCA":{
               "ProductDetails":{
                  ...
                  "Notes":[
                     "We'll only charge you a single fee - whichever is highest. So, for example, if your've exceeded your overdraft limit, exceeded your Emergency Borrowing Limit and had a transaction returned as unpaid, all on the same day, we'll only charge your the Â£8 Unpaid Transaction Fee"
                  ]
               }
            }
         }
               ...
               "CreditInterest":{
                  "TierBandSet":{
                     ...
                     "Notes":[
                        ...
                        "We are replacing the current tiered rates with a single interest rate of 2% AER(1.98% gross) (variable) on credit balances between Â£1 and Â£5,000. Depending on the balance of your account this may be an increase or decrease to the rate your currently receive."
                     ],
                     "TierBand":[
                        {
                           "Identification":"1",
            ...
            "PCA":{
               "CreditInterest":{
                  "TierBandSet":{
                     ...
                     "CalculationMethod":"Compound",
                     "Notes":[
                        "No interest on balances over Â£5000"
                     ],
                     "TierBand":[
                        {
                           "Identification":"1",
                  ...
                  "OverdraftTierBandSet":[
                     {
                        ...
                        "BufferAmount":"0.00",
                        "Notes":[
                           "If you've graduated within the last 3 years, you can apply for an overdraft of upto Â£3,000 (subject to status). This is a breakdown of the fee free amounts available based on how long ago you graduated.",
                           "The maximum overdraft you can apply for with this account is Â£3,000."
                        ],
                        "OverdraftTierBand":[
                           {
...
Daily arranged overdraft fee: Â£0.50 per day (with £10 buffer amount)
Daily unarranged overdraft fee: Â£5 per day (capped at £60 per calendar month)
                                    ...
                                    "OverdraftFeeChargeDetail":[
                                       {
                                          ...
                                          "Notes":[
                                             ...
                                             "You'll pay a daily overdraft fee of 1p for every Â£7 you borrow, over your Â£1000 fee-free amount. When calculating the daily overdraft fee, we will only use every full Â£7 you have borrowed, so if you borrow less than Â£7 you won't be charged.",
