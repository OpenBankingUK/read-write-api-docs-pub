# Event Notifications - v3.1.4 <!-- omit in toc -->
...
5. [Usage Examples](#usage-examples)
   ...
   2. [Send Event Notification - CBPII Consent Authorisation Revoked](#send-event-notification---cbpii-consent-authorisation-revoked)
   ...
   3. [Send Event Notification - AIS Consent Authorisation Revoked](#send-event-notification---ais-consent-authorisation-revoked)
      1. [POST Event Notification Request](#post-event-notification-request-2)
      2. [POST Event Notification Response](#post-event-notification-response-2)
