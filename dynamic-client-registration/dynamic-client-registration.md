...
| grant_types	                     | 1..* | grant_types | A JSON array specifying what the TPP can request to be supplied to the token endpoint as exchangefor an access token	| String[] (32) |client_credentials authorization_code refresh_token urn:openid:params:grant-type:ciba urn:ietf:params:oauth:grant-type:jwt-bearer  || Both |
