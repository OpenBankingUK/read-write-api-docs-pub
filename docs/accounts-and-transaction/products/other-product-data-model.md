# Other Product Data Model - v3.1.7 
## Overview
...
![ OtherProductInfoMainPage.png ](OtherProduct/OtherProductInfoMainPage.png )
...
![ OtherProductInfoCreditInterest.png ](OtherProduct/OtherProductInfoCreditInterest.png )
...
![ OtherProductInfoOverdraft.png ](OtherProduct/OtherProductInfoOverdraft.png )

#### LoanInterest

* A generic structure for Loan Interest published only if applicable to Other Product Type .

![ OtherProductInfoLoanInterest.png ](OtherProduct/OtherProductInfoLoanInterest.png )

#### Repayment

* A generic structure for Loan Repayment along with Fee Charges published only if applicable to Other Product Type.

![ OtherProductInfoRepayment.png ](OtherProduct/OtherProductInfoRepayment.png )

#### OtherFeesCharges

* A generic structure for Other Fee Charges published only if applicable to Other Product Type.

![ OtherProductInfoOtherFeesCharges.png ](OtherProduct/OtherProductInfoOtherFeesCharges.png )
...
![ OtherProductInfoSupplementaryData.png ](OtherProduct/OtherProductInfoSupplementaryData.png )

### Data Payload

![ OtherProductInfo.png ](OtherProduct/OtherProductInfo.png )

### Data Dictionary

* [Other Product Type Data Definition](../../resources-and-data-models/aisp/productdatafiles/OtherProductInfo.v3.1.2.DD.xlsx )


### Data Payload - Enumerations

* [Other Product Type Code List](../../resources-and-data-models/aisp/productdatafiles/OtherProduct.v3.1.2.CodeList.xlsx )
