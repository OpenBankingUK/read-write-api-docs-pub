...
umldiagram --src=https://raw.githubusercontent.com/OpenBankingUK/read-write-api-specs/v3.1.11-draft1/dist/openapi/account-info-openapi.yaml --api-version=3 --dir=resources-and-data-models/aisp/images\
...
umldiagram --src=https://raw.githubusercontent.com/OpenBankingUK/read-write-api-specs/v3.1.11-draft1/dist/openapi/payment-initiation-openapi.yaml --api-version=3 --dir=resources-and-data-models/pisp/images\
	--schema=OBRisk1\
...
umldiagram --src=https://raw.githubusercontent.com/OpenBankingUK/read-write-api-specs/v3.1.11-draft1/dist/openapi/confirmation-funds-openapi.yaml --api-version=3 --dir=resources-and-data-models/cbpii/images\
...
umldiagram --src=https://raw.githubusercontent.com/OpenBankingUK/read-write-api-specs/v3.1.11-draft1/dist/openapi/event-notifications-openapi.yaml --api-version=3 --dir=resources-and-data-models/event-notifications/images\
