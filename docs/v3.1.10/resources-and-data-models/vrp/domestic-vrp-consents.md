...
| __PSUInteractionTypes__ (1..M)      | `ControlParameters. PSUInteractionTypes`               | Indicates that the PSU authentication methods supported.                                                                                                                                                                                                                         | OBVRPInteractionTypes                               |
...
| PaymentContextCode                             | 0..1       | OBRisk1/PaymentContextCode                             | Specifies the payment context                                                                                                                                                                       | OBExternalPaymentContext1Code | BillPayment<br>InvoicePayment<br>PispPayee<br>EcommerceMerchantInitiatedPayment<br>FaceToFacePointOfSale<br>TransferToSelf<br>TransferToThirdParty<br> |         |
...
| BeneficiaryPaymentDetailsPrepopulatedIndicator | 0..1       | OBRisk1/BeneficiaryPaymentDetailsPrepopulatedIndicator | Indicates if PISP has immutably prepopulated payment details in for the PSU.                                                                                                                        | Boolean                       |
| PayeeAccountName                               | 0..1       | OBRisk1/PayeeAccountName                               | Name of the account, as assigned by the account servicing institution. to be provided when ContractPresentInidicator is true.                                                                       | Max70Text                     |
...
| BeneficiaryAccountType                         | 0..1       | OBRisk1/BeneficiaryAccountType                         | To be provided if the AccountType is known.                                                                                                                                                         | OBExternalAccountType1Code    |
