# Open Banking Read-Write API Profile  - v3.1.7 
...
![](assets/MissingOrExpiredAccessToken.png)
...
![](assets/IncompleteOrMalformedRequestPayload.png)
...
![](assets/MissingOrInvalidAccessTokenScope.png)
...
![](assets/FailedAuthorisationConsent.png)
