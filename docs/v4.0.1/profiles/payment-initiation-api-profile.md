...
| ReferredDocumentAmount |0..1 |OBRemittanceInformation2/Structured/ReferredDocumentAmount | Provides details on the amounts of the referred document. |OBActiveCurrencyAndAmount_SimpleType| | 
