...
The Initiation section of the Payment API payloads is based on the ISO 20022 pain.001 XML standard and we have used ISO 20022 message elements or components where possible. However, it has been adapted for APIs based as per our design principles.
...
* Only required fields have been included in the Initiation objects. This has meant:
  ...
  * PaymentInformationIdentification not required - we also have an InstructionIdentification.
...
*	Existing objects such as Postal Address and Remittance Information are enhanced as per the latest versions of pain and pacs.
...
* FPS scheme requirements (are not formally part of the Open Banking API Specification, but are included for guidance):
  ...
  * There is also a requirement from the FPS scheme to identify the PISP via field 122 REGULATORY REPORTING
...
* Beneficiary Reference (70) - this MT103 field has 4 fields of length 35 to be mapped with:
  * /ROC/ and EndToEndIdentification
