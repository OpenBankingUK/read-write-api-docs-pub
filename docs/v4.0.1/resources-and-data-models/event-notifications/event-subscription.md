# Event Subscription - v4.0.1

- [Overview](#overview)
- [Endpoints](#endpoints)
  - [POST /event-subscriptions](#post-event-subscriptions)
  - [GET /event-subscriptions](#get-event-subscriptions)
  - [PUT /event-subscriptions/{EventSubscriptionId}](#put-event-subscriptions-eventsubscriptionid)
  - [DELETE /event-subscriptions/{EventSubscriptionId}](#delete-event-subscriptions-eventsubscriptionid)
