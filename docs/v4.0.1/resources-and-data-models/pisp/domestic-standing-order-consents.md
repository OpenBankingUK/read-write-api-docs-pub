...
| MandateRelatedInformation | 0..1 |OBDomesticStandingOrder3/MandateRelatedInformation |Provides further details of the mandate signed between the creditor and the debtor, such as frequency, which is **mandatory**.|OBMandateRelatedInformation1| | |
