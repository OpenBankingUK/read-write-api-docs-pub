...
| LEI |0..1 | OBReadScheduledPayment3/Data/ScheduledPayment/CreditorAgent/LEI |Legal Entity Identification by which a party is known and which is usually used to identify that party. |Max20Text | | |
