# Offers - v4.0-draft1 <!-- omit in toc -->
...
| OfferType |0..1 |OBReadOffer1/Data/Offer/OfferType |Offer type, in a coded form. For more information see `OBExternalOfferType1Code` [here](https://github.com/OpenBankingUK/External_Interal_CodeSets) |OBExternalOfferType1Code |BalanceTransfer<br>LimitIncrease<br>MoneyTransfer <br>Other<br>PromotionalRate | |
