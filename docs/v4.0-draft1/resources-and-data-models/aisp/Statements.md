# Statements - v4.0-draft1 <!-- omit in toc -->
...
| Type |1..1 |OBReadStatement2/Data/Statement/Type |Statement type, in a coded form. | For a full list of enumeration values refer to `OB_Internal_CodeSet` [here](https://github.com/OpenBankingUK/External_internal_CodeSets). |OBInternalStatementType1Code| |
...
| RateType |0..1 |OBReadStatement2/Data/Statement/StatementFee/RateType |Description that may be available for the statement fee rate type. |or a full list of enumeration values refer to `OB_Internal_CodeSet` [here](https://github.com/OpenBankingUK/External_internal_CodeSets).  |OBInternalStatementFeeRateType1Code | |
| Frequency |0..1 |OBReadStatement2/Data/Statement/StatementFee/Frequency |How frequently the fee is applied to the Account. |For a full list of enumeration values refer to `OB_Internal_CodeSet` [here](https://github.com/OpenBankingUK/External_internal_CodeSets).  |OBInternalStatementFeeFrequency1Code | |
...
| RateType |0..1 |OBReadStatement2/Data/Statement/StatementInterest/RateType |Description that may be available for the statement Interest rate type. |For a full list of enumeration values refer to `OB_Internal_CodeSet`[here] (https://github.com/OpenBankingUK/External_internal_CodeSets). |OBInternalStatementInterestType1Code| |
| Frequency |0..1 |OBReadStatement2/Data/Statement/StatementInterest/Frequency |How frequently the Interest Rate is applied to the Account. |For a full list of enumeration values refer to `OB_Internal_CodeSet`[here] (https://github.com/OpenBankingUK/External_internal_CodeSets). |OBInternalStatementInterestFrequency1Code| |
