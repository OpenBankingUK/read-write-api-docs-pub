...
| AccountTypeCode |0..1 |OBReadAccount6/Data/Account/AccountTypeCode |Specifies the sub type of account (product family group). For a full description see `OBExternalCashAccountType1Code` [here](https://github.com/OpenBankingUK/External_Interal_CodeSets). |OBExternalCashAccountType1Code | |
...
| Frequency |0..1 |OBReadAccount6/Data/Account/StatementFrequencyAndFormat/Frequency |For a full description see `ExternalDateFrequency1Code` [here](https://github.com/OpenBankingUK/External_Interal_CodeSets) |ExternalDateFrequency1Code | | |
| CommunicationMethod |0..1 |OBReadAccount6/Data/Account/StatementFrequencyAndFormat/CommunicationMethod |For a full description see `ExternalCommunicationFormat1Code` [here](https://github.com/OpenBankingUK/External_Interal_CodeSets) |ExternalCommunicationFormat1Code | | |
| Format |0..1 |OBReadAccount6/Data/Account/StatementFrequencyAndFormat/Format |For a full description see `ExternalDocumentFormat1Code` [here](https://github.com/OpenBankingUK/External_Interal_CodeSets)|ExternalDocumentFormat1Code | | |
