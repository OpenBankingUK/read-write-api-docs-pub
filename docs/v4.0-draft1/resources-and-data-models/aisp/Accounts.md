...
| AccountTypeCode |0..1 |OBReadAccount6/Data/Account/AccountTypeCode |Specifies the sub type of account (product family group). |OBExternalCashAccountType1Code |CACC<br>CARD<br>CASH<br>CHAR<br>CISH<br>COMM<br>CPAC<br>LLSV<br>LOAN<br>MGLD<br>MOMA<br>NFCA<br>NREX<br>ODFT<br>ONDP<br>OTHR<br>SACC<br>SLRY<br>SVGS<br>TAXE<br>TRAN<br>TRAS<br>VACC<br>MORT<br>WALT<br><br>Note: MORT & WALT are OBProprietary codes<br><br>Refer to the [External_Internal_codesets repository](https://github.com/OpenBankingUK/External_Interal_CodeSets)| |
...
| Format |0..1 |OBReadAccount6/Data/Account/StatementFrequencyAndFormat/Format |DPDF<br>DXML<br>SDSH<br>WORD<br>XSLT|ExternalDocumentFormat1Code | | |
