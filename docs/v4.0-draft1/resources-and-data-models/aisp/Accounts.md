...
| DeliveryAddress |0..1 |OBReadAccount6/Data/Account/DeliveryAddress |The address the statement is delivered to| | |
| Frequency |0..1 |OBReadAccount6/Data/Account/StatementFrequencyAndFormat/Frequency |YEAR (Annual)<br>DAIL (Daily)<br>INDA (Intra Day)<br>MNTH (Monthly)<br>QURT (Quarterly)<br>MIAN (Semi Annual)<br>TEND (Ten Days)<br>MOVE (Triggered By Movement)<br>WEEK (Weekly) |OBFrequency2 | | |
