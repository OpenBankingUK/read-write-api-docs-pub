...
| AccountTypeCode |0..1 |OBReadAccount6/Data/Account/AccountTypeCode |Specifies the sub type of account (product family group). For a full description see `OBExternalCashAccountType1Code` [here](https://github.com/OpenBankingUK/External_Internal_CodeSets). |OBExternalCashAccountType1Code | |
...
| LEI |0..1 | OBReadAccount6/Data/Account/Account/LEI |Legal Entity Identification |Max20Text | | |
...
| Frequency |0..1 |OBReadAccount6/Data/Account/StatementFrequencyAndFormat/Frequency |For a full description see `ExternalDateFrequency1Code` [here](https://github.com/OpenBankingUK/External_Internal_CodeSets) |ExternalDateFrequency1Code | | |
...
| Format |0..1 |OBReadAccount6/Data/Account/StatementFrequencyAndFormat/Format |For a full description see `ExternalDocumentFormat1Code` [here](https://github.com/OpenBankingUK/External_Internal_CodeSets)|ExternalDocumentFormat1Code | | |
