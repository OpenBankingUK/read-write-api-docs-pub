...
| __Reference__ (0..1) | `RemittanceInformation. Reference` |Unique reference, as assigned by the creditor, to unambiguously refer to the payment transaction. The PISP may populate this with different values from those specified in the `Data.Initiation.RemittanceInformation.Reference` field of the consent. |Max35Text
