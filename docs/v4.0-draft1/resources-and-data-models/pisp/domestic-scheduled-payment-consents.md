...
| RelatedDate |0..1 |OBDomesticScheduled2/RemittanceInformation/Structured/ReferredDocumentInformation/Number |TDate associated with the referred document line |ISODateTime | | |
...
| CreditorReferenceInformation |0..1 |OBDomesticScheduled2/CreditorReferenceInformation/Structured/ReferredDocumentInformation|Reference information provided by the creditor to allow the identification of the underlying documents |OBCreditorReferenceInformation| | |
| Code |0..1 |OBDomesticScheduled2/CreditorReferenceInformation/Structured/ReferredDocumentInformation/Code |Type of creditor reference, as published in an external creditor reference type code set. For a full description see `ExternalCreditorReferenceType1Code` [here](https://github.com/OpenBankingUK/External_Interal_CodeSets) |ExternalCreditorReferenceType1Code| | |
| Issuer |0..1 |OBDomesticScheduled2/CreditorReferenceInformation/Structured/ReferredDocumentInformation/Issuer |Entity that assigns the credit reference type |Max35Text | | |
...
| TaxRemittance |0..1 |OBDomesticScheduled2/CreditorReferenceInformation/Structured/TaxRemittance |Provides remittance information about a payment made for tax-related purposes |Max140Text| | |
