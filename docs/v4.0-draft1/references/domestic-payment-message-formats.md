...
This is the mapping from the Initiation section to the legacy CHAPS scheme fields with the use of the "UK.OBIE.SortCodeAccountNumber" account identification SchemeName.
