# Domestic Scheduled Payment Consents  - v3.1.7
...
![OBDomesticScheduled2](../resources-and-data-models/pisp/images/OBDomesticScheduled2.gif)
...
![Domestic Scheduled Payment Consent - Request](../resources-and-data-models/pisp/images/OBWriteDomesticScheduledConsent4.png)
...
![Domestic Scheduled Payment Consent - Response](../resources-and-data-models/pisp/images/OBWriteDomesticScheduledConsentResponse5.gif)
...
* CutOffDateTime Behaviour is explained in the Payment Initiation API Profile, Section - [Payment Restrictions -> CutOffDateTime Behaviour](payment-initiation-api-profile.md#cutoffdatetime-behaviour).
